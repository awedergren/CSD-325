...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        todo1 = tk.Label(self.tasks_frame, text="---Items Added---**Right Click Item to Delete**", bg="mediumturquoise",
            fg="black", pady=10)
        ...
        self.colour_schemes = [{"bg": "mediumturquoise", "fg": "black"}, {"bg": "salmon", "fg": "black"}]
    ...
    def remove_task(self, event):
        task = event.widget
        if msg.askyesno("ReallyDelete?", "Delete" + task.cget("text") + "?"):
