...
INITIAL_TREE_DENSITY = 0.01  # Amount of forest that starts with trees.
...
def main():
    ...
    while True:  # Main program loop.
        ...
        place_lake(forest, lake_x, lake_y, lake_width, lake_height)
...
# Place a lake in the forest
def place_lake(forest, lake_x, lake_y, lake_width, lake_height):
